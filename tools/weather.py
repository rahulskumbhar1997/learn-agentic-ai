...
class Weather(Tool):
    ...
    def description(self):
        return "Get weather details for given longitude and latitude."
    ...
    def execute(self, latitude, longitude, current_fields=None, hourly_fields=None, daily_fields=None):
