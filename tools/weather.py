...
@tool(args_schema=weather_schema, description="Get the weather details for provided coordinates.")
def get_weather(latitude: str, longitude: str, current_fields=None, hourly_fields=None, daily_fields=None):
    """
